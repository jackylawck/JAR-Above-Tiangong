  ...
  constructor() {
    ...
    this.dict = {
      'zh-HK': {
        ...
        modeManual: '手動',
        modeLocked: '手動 (鎖定)',
        narrKid: 'Jarvis，天宮就喺眼前！大膽推前推進，衝過頭可以向後拉倒車！',
      ...
      'en': {
        ...
        narrKid: 'Jarvis, Tiangong is right ahead! Push full thrust, pull back to reverse if overshot!',
        ...
        narrSuccess: 'Hard Dock Confirmed! J.A.R. salutes you on a successful mission!',
